		...
		try {
			...
			while (fichier.hasNextLine()) {
				try {
					...
					Generateur chaineResp = new GenerateurAmExImpl(new GenerateurDiscoverImpl(new GenerateurVisaImpl(new GenerateurMasterCardImpl(new GenerateurDinersClubImpl(null)))));
					CarteDeCredit carteDeCredit = chaineResp.creerCarte(parts[0], dateExpiration, parts[2]);
